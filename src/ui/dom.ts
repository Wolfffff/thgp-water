...
function buildSidebar(): HTMLElement {
  ...
  const filterSection = el('div', { className: 'sidebar-section' },
    ...
    el('div', { className: 'filter-group' },
      el('label', { className: 'filter-label' }, 'Alerts (count of exceeded thresholds)'),
      el('div', { className: 'range-slider', id: 'alerts-range' },
        el('div', { className: 'range-slider-labels' },
          el('span', { className: 'range-slider-label-min', id: 'alerts-range-min-label' }, '0'),
          el('span', { className: 'range-slider-label-max', id: 'alerts-range-max-label' }, '0'),
        ),
        el('div', { className: 'range-slider-track' },
          el('div', { className: 'range-slider-fill', id: 'alerts-range-fill' }),
        ),
        el('input', { type: 'range', className: 'range-slider-input range-slider-input--min', id: 'alerts-range-min' }),
        el('input', { type: 'range', className: 'range-slider-input range-slider-input--max', id: 'alerts-range-max' }),
      ),
    ),
    el('div', { className: 'filter-group', id: 'param-range-group', style: 'display:none' },
      el('label', { className: 'filter-label', id: 'param-range-label' }, 'Selected parameter'),
      el('div', { className: 'range-slider', id: 'param-range' },
        el('div', { className: 'range-slider-labels' },
          el('span', { className: 'range-slider-label-min', id: 'param-range-min-label' }, '—'),
          el('span', { className: 'range-slider-label-max', id: 'param-range-max-label' }, '—'),
        ),
        el('div', { className: 'range-slider-track' },
          el('div', { className: 'range-slider-fill', id: 'param-range-fill' }),
        ),
        el('input', { type: 'range', className: 'range-slider-input range-slider-input--min', id: 'param-range-min' }),
        el('input', { type: 'range', className: 'range-slider-input range-slider-input--max', id: 'param-range-max' }),
      ),
    ),
  );
